...
set_correct_permissions "${UMBREL_DATA_STORAGE_AUDIOBOOKS_DIR}"
set_correct_permissions "${UMBREL_DATA_STORAGE_PODCASTS_DIR}"
set_correct_permissions "${UMBREL_DATA_STORAGE_ABS_CONFIG}"
set_correct_permissions "${UMBREL_DATA_STORAGE_ABS_METADATA}"